...
public class ScootersApplication implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        jdbcTemplate.execute("CREATE TABLE transactions(" +
                "scooterid VARCHAR(255) REFERENCES scooters(scooterid), event VARCHAR(255), email VARCHAR(255)," +
                "old_status VARCHAR(255), new_status VARCHAR(255), transaction_date TIMESTAMP)");
    }
}
